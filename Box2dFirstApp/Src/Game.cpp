...
{ 
	...
	//OBSTACULOS
	sf::RectangleShape obstacle1Shape(sf::Vector2f(10, 5));
	obstacle1Shape.setFillColor(sf::Color::Red);
	obstacle1Shape.setPosition(45, 47.5f);
	wnd->draw(obstacle1Shape);

	sf::RectangleShape obstacle2Shape(sf::Vector2f(10, 5));
	obstacle2Shape.setFillColor(sf::Color::Cyan);
	obstacle2Shape.setPosition(75, 60);
	wnd->draw(obstacle2Shape);

	sf::RectangleShape obstacle3Shape(sf::Vector2f(10, 5));
	obstacle3Shape.setFillColor(sf::Color::Green);
	obstacle3Shape.setPosition(15, 60);
	wnd->draw(obstacle3Shape);
...
void Game::InitPhysics()
{
	...
	b2Body* obstacle1Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 5);
	obstacle1Body->SetTransform(b2Vec2(50.0f, 50.0f), 0.0f);

	b2Body* obstacle2Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 5);
	obstacle2Body->SetTransform(b2Vec2(80.0f, 62.5f), 0.0f);

	b2Body* obstacle3Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 5);
	obstacle3Body->SetTransform(b2Vec2(20.0f, 62.5f), 0.0f);
	...
	controlBody->SetTransform(b2Vec2(60.0f, 60.0f), 0.0f);

	controlBody->SetAwake(true);
	//controlBody->SetAngularVelocity(1);
	controlBody->SetLinearVelocity(b2Vec2(-30.0f, 20.0f));
